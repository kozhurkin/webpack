...
const applyJavascriptParserOptionsDefaults = options => {
	...
	if (typeof entries === "object") {
		F(entries, "__webpack_web_entry__", () => ({}));
		const __webpack_web_entry__ = entries.__webpack_web_entry__;
		if (typeof __webpack_web_entry__ === "object") {
			D(__webpack_web_entry__, "dependencyType", "import");
			D(__webpack_web_entry__, "return", "files");
			F(__webpack_web_entry__, "entryOptions", () => ({}));
			D(__webpack_web_entry__.entryOptions, "chunkFormat", "array-push");
			D(__webpack_web_entry__.entryOptions, "layer", "web");
		}
	}
};
